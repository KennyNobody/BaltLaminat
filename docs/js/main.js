...
// (function(){
// 	const links = document.querySelectorAll('.case__title');
...
$(document).ready(function () {
  $('[data-modal]').click(function (e) {
    $.fancybox.close(); // $(this).addClass('head-nav__link--active');
    ...
    $.fancybox.open({
      ...
      opts: {
        ...
        btnTpl: {
          close: '<button data-fancybox-close class ="custom fancybox-button fancybox-button - close "title =" {{CLOSE}} ">' + '<svg xmlns = "http://www.w3.org/2000/svg" viewBox = "0 0 24 24"> <path d = "M12 10.6L6.6 5.2 5.2 6.6l5.4 5.4-5.4 5.4 1.4 1.4 5.4-5.4 5.4 5.4 1.4-1.4-5.4-5.4 5.4-5.4-1.4-1.4-5.4 5.4z "/> </ svg> ' + " </ button> "
        }
      }
    });
  });
...
/* harmony import */ var _modules_case_case__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! %modules%/case/case */ "./src/blocks/modules/case/case.js");
/* harmony import */ var _modules_case_case__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(_modules_case_case__WEBPACK_IMPORTED_MODULE_5__);
